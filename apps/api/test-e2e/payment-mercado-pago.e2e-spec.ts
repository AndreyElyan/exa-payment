...
describe("Payment Mercado Pago Integration (e2e) - US8", () => {
  ...
  describe("Mercado Pago Integration Scenarios", () => {
    ...
    it("Scenario 3: CREDIT_CARD payment with CPF validation", async () => {
      const paymentData = {
        cpf: "12345678909",
    ...
    it("Scenario 4: CREDIT_CARD payment with external reference", async () => {
      const paymentData = {
        cpf: "55566677788",
  ...
  describe("Error Handling Scenarios", () => {
    it("Scenario 5: Mercado Pago API timeout", async () => {
    ...
    it("Scenario 6: Mercado Pago API error handling", async () => {
      // Mock error response
      (global.fetch as any).mockResolvedValue({
        ok: false,
        status: 400,
  ...
  describe("Idempotency with Provider Integration", () => {
    it("Scenario 7: Idempotency with Mercado Pago integration", async () => {
      const paymentData = {
        cpf: "12345678909",
    ...
    it("Scenario 8: Idempotency conflict with different payload", async () => {
  ...
  describe("Performance and Load Testing", () => {
    it("Scenario 9: Multiple CREDIT_CARD payments performance", async () => {
    ...
    it("Scenario 10: Mixed PIX and CREDIT_CARD payments", async () => {
      const pixPayment = {
        cpf: "12345678909",
  ...
  describe("Database Integration Scenarios", () => {
    it("Scenario 11: Database persistence with provider integration", async () => {
      const paymentData = {
        cpf: "12345678909",
    ...
    it("Scenario 12: Database consistency with multiple payments", async () => {
      const payments = [
        {
          cpf: "11111111111",
